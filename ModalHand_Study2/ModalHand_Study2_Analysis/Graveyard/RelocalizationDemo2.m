...
folder = "C:\Users\Dustin Goetz\Desktop\ReTouch_Lab\Lab_Projects\Project_ModalHand\ModalHand_Study2\ModalHand_Study2_Measurements\Data\";
...
for iter2 = 1:length(conditions)
        for iter3 = 1:length(freq)
            ttest(squeeze(accuracy(:,iter2,iter3)))
        end
end
