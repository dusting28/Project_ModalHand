...
%% Figure
figure
loglog(freq,1000*(2*pi*freq).^1.*abs(y1_out),'r');
hold on;
loglog(freq,1000*(2*pi*freq).^1.*abs(y2_out),'Color',[0.9290 0.6940 0.1250]);
loglog(freq,1000*(2*pi*freq).^1.*abs(y3_out),'Color',[0 0.4470 0.7410]);
loglog(freq,1000*(2*pi*freq).^1.*abs(y4_out),'Color',[.85 0 .75]);
hold off;
...
figure
semilogx(freq,1000*(2*pi*freq).^1.*abs(y0_out),'k');
hold on;
semilogx(freq,1000*(2*pi*freq).^1.*abs(y1_out),'r');
semilogx(freq,1000*(2*pi*freq).^1.*abs(y2_out),'Color',[0.9290 0.6940 0.1250]);
semilogx(freq,1000*(2*pi*freq).^1.*abs(y3_out),'Color',[0 0.4470 0.7410]);
semilogx(freq,1000*(2*pi*freq).^1.*abs(y4_out),'Color',[.85 0 .75]);
hold off;
legend('Distal Phalanx','Medial Phalanx','Proximal Phalanx','Metacarpal')
title('Admittance')
ylabel('$\frac{\dot{x}}{F}$ (mm/Ns)','interpreter','latex')
...
figure
subplot(1,3,1)
semilogx(freq,20*log10(1./((2*pi*freq).^1.*abs(y0_out))),'k');
hold on;
semilogx(freq,20*log10(1./((2*pi*freq).^1.*abs(y1_out))),'r');
semilogx(freq,20*log10(1./((2*pi*freq).^1.*abs(y2_out))),'Color',[0.9290 0.6940 0.1250]);
semilogx(freq,20*log10(1./((2*pi*freq).^1.*abs(y3_out))),'Color',[0 0.4470 0.7410]);
semilogx(freq,20*log10(1./((2*pi*freq).^1.*abs(y4_out))),'Color',[.85 0 .75]);
hold off;
...
xlabel('Frequency (Hz)')
subplot(1,3,2)
semilogx(freq,20*log10(((2*pi*freq).^1.*abs(y0_out))),'k');
hold on;
semilogx(freq,20*log10(((2*pi*freq).^1.*abs(y1_out))),'r');
semilogx(freq,20*log10(((2*pi*freq).^1.*abs(y2_out))),'Color',[0.9290 0.6940 0.1250]);
semilogx(freq,20*log10(((2*pi*freq).^1.*abs(y3_out))),'Color',[0 0.4470 0.7410]);
semilogx(freq,20*log10(((2*pi*freq).^1.*abs(y4_out))),'Color',[.85 0 .75]);
hold off;
legend('Contact Point','Distal Phalanx','Medial Phalanx','Proximal Phalanx','Metacarpal')
title('Admittance')
...
xlabel('Frequency (Hz)')
subplot(1,3,3)
semilogx(freq,20*log10((2*pi*freq).^1.*abs(y0_out-y1_out)),'k');
hold on;
semilogx(freq,20*log10((2*pi*freq).^1.*abs(theta1_out-theta2_out)*l1/2),'Color',[0.8500 0.3250 0.0980]);
semilogx(freq,20*log10((2*pi*freq).^1.*abs(theta2_out-theta3_out)*(l1/2+l2)),'Color',[0.4660 0.6740 0.1880]);
semilogx(freq,20*log10((2*pi*freq).^1.*abs(theta3_out-theta4_out)*(l1/2+l2+l3)),'Color',[0.7 0.2 0.8]);
semilogx(freq,20*log10((2*pi*freq).^1.*abs(theta4_out)*(l1/2+l2+l3+l4)),'m');
hold off;
...
figure
hold on;
plot(freq,1000*(2*pi*freq).^1.*abs(y0_out),'k');
plot(freq,1000*(2*pi*freq).^1.*abs(y1_out),'r');
plot(freq,1000*(2*pi*freq).^1.*abs(y2_out),'Color',[0.9290 0.6940 0.1250]);
plot(freq,1000*(2*pi*freq).^1.*abs(y3_out),'Color',[0 0.4470 0.7410]);
plot(freq,1000*(2*pi*freq).^1.*abs(y4_out),'Color',[.85 0 .75]);
hold off;
legend('Contact Point','Distal Phalanx','Medial Phalanx','Proximal Phalanx','Metacarpal')
title('Admittance')
ylabel('$\frac{\dot{x}}{F}$ (mm/Ns)','interpreter','latex')
...
figure
hold on;
plot(freq,1000*(2*pi*freq).^1.*abs(y0_out-y1_out),'k');
plot(freq,1000*(2*pi*freq).^1.*abs(theta1_out-theta2_out)*l1/2,'Color',[0.8500 0.3250 0.0980]);
plot(freq,1000*(2*pi*freq).^1.*abs(theta2_out-theta3_out)*(l1/2+l2),'Color',[0.4660 0.6740 0.1880]);
plot(freq,1000*(2*pi*freq).^1.*abs(theta3_out-theta4_out)*(l1/2+l2+l3),'Color',[0.7 0.2 0.8]);
plot(freq,1000*(2*pi*freq).^1.*abs(theta4_out)*(l1/2+l2+l3+l4),'m');
hold off;
legend('Skin Compression','DIP','PIP','MCP','Wrist')
title('Contribution to Contact Admittance')
ylabel('$\frac{\dot{x}}{F}$ (mm/Ns)','interpreter','latex')
...
figure
hold on;
plot(freq,1000*(2*pi*freq).^1.*abs(y1_out-y0_out));
plot(freq,1000*(2*pi*freq).^1.*abs(y_fixed));
hold off;
...
figure
hold on;
plot(freq,(2*pi*freq).^0.*abs(theta1_out-theta2_out));
plot(freq,(2*pi*freq).^0.*abs(theta2_out-theta3_out));
plot(freq,(2*pi*freq).^0.*abs(theta3_out-theta4_out));
plot(freq,(2*pi*freq).^0.*abs(theta4_out));
hold off;
